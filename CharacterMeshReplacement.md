...
If Character_Mesh_3P_Override_LODs is greater than zero then the game will try to load prefabs for each LOD index e.g. Character_Mesh_3P_Override_0. These should have MeshFilter componens for the third person replacement meshes.
